...
export const businesses: Business[] = [
  // --- Vendo's own paid services ---
  {
    ...
    routes: [{ method: "GET", path: "/statement", priceUsd: 0.05, summary: "Monthly revenue statement for a business",
  ...
  },
  {
    ...
    ownerApproved: true,
    licence: "Vendo service.",
    routes: [{ method: "GET", path: "/check", priceUsd: 0.10, summary: "Discoverability score, agent find-test and fixes for a listing",
  ...
  // --- Real-world finance and business data (the Vendo wedge on OKX AI) ---
  {
    ...
    routes: [
      { method: "GET", path: "/check", priceUsd: 0.10, summary: "Counterparty check for a company name, LEI and/or wallet",
        tiers: [
          { name: "basic", priceUsd: 0, includes: "Sanctions screen only. Free, no payment needed" },
          { name: "standard", priceUsd: 0.10, includes: "Sanctions screen and legal entity registry check" },
          { name: "premium", priceUsd: 0.30, includes: "Registry, sanctions, verified wallet check and a signed report" },
        ],
      ...
      { method: "GET", path: "/sanctions", priceUsd: 0.03, summary: "Screen a name against the US OFAC sanctions list",
  ...
  },
  {
    ...
    routes: [{ method: "GET", path: "/q", priceUsd: 0.10, summary: "Ask a question and get a paid answer from whichever Vendo service fits",
  ...
  },
  {
    ...
    routes: [{ method: "GET", path: "/asp", priceUsd: 0.03, summary: "Delivery track record for a listed store",
  ...
  },
  {
    ...
    routes: [{ method: "GET", path: "/company", priceUsd: 0.03, summary: "Company profile and recent SEC filings",
  ...
  },
  {
    ...
    routes: [{ method: "GET", path: "/calc", priceUsd: 0.02, summary: "Invoice tax and currency conversion",
